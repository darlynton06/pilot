...
<body id="home" class="index">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#home">GEBOS</a>
            </div>
                    ...
                    <ul class="timeline">
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Our mission is to provide you with the highest quality products and services possible in a timely fashion at a competitive price</p>
                                </div>
                            </div>
                        </li>
                        <li>
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        ...
                        <i class="fa mdi mdi-printer fa-stack-1x fa-inverse"></i>
                    </span>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; Gebos 2017</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
                        <li><a href="#"><i class="fa fa-twitter"></i></a>
...
<!-- Mirrored from blackrockdigital.github.io/startbootstrap-agency/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jul 2017 15:37:24 GMT -->
</html>
